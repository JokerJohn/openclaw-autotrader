...
- Last snapshot / 最新快照: 2026-05-01 00:58:40 CST (UTC+08:00)
...
- Time / 时间: 2026-05-01 01:03:33 CST (UTC+08:00)
- Market / 市场: US
- Reason / 理由: critic gate 拦截：final expected_edge_pct -1.50% 低于成本覆盖门槛 0.31% / critic gate 拦截：final expected_edge_pct -1.50% 低于成本覆盖门槛 0.31%
- Decision basis / 决策依据: Regime: unavailable; Path: standard decision flow; Model: A; Purpose: standard review; confidence 0.00. / 市场状态：暂无；决策链路：常规决策链路；模型：A；目的：常规审查；置信度 0.00。
