...
Updated / 更新时间: 2026-03-14 03:27:23 CST (UTC+08:00)
...
**Summary / 摘要**: 2026-03-14 共 24 次计划、0 次成交、0 次换汇记录，对账权益 HKD 4,889.60，对账累计盈亏 HKD -110.40，对账未实现盈亏 HKD -18.36。
...
| End Equity / 结束权益 | HKD 4,889.60 |
| End Net PnL / 结束累计盈亏 | HKD -110.40 |
| End Unrealized PnL / 结束未实现盈亏 | HKD -18.36 |
| Trade Episodes / 交易片段 | 2 |

**Recent Trade Episodes / 最近交易片段**

- BUY SNDK | plan_only | edge=+1.27% | conf=0.59 | q=+0.00
