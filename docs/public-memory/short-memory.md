...
**Summary / 摘要**: 2026-05-05 共 2 次计划、0 次成交、0 次换汇记录，对账权益 HKD 9,787.43，对账账本周期盈亏 HKD -212.57，对账未实现盈亏 +HKD 165.01。
...
| Benchmarks / 基准快照 | 2 |
| Latest Decision / 最新决策 | [US] HOLD 无 |
| End Equity / 结束权益 | HKD 9,787.43 |
| End Net PnL / 结束累计盈亏 | HKD -212.57 |
| End Unrealized PnL / 结束未实现盈亏 | HKD 165.01 |
| Trade Episodes / 交易片段 | 0 |
