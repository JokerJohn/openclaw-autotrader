...
Updated / 更新时间: 2026-03-14 03:54:06 CST (UTC+08:00)
...
**Summary / 摘要**: 2026-03-14 共 27 次计划、0 次成交、0 次换汇记录，对账权益 HKD 4,889.20，对账累计盈亏 HKD -110.80，对账未实现盈亏 HKD -18.76。
...
| FX Events / 换汇记录 | 0 |
| Benchmarks / 基准快照 | 24 |
| Latest Decision / 最新决策 | [US] BUY SNDK |
| End Equity / 结束权益 | HKD 4,889.20 |
| End Net PnL / 结束累计盈亏 | HKD -110.80 |
| End Unrealized PnL / 结束未实现盈亏 | HKD -18.76 |
| Trade Episodes / 交易片段 | 5 |

**Recent Trade Episodes / 最近交易片段**

- BUY SNDK | plan_only | edge=+0.66% | conf=0.62 | q=+0.00
- BUY SNDK | plan_only | edge=+0.80% | conf=0.55 | q=-1.91 | one_hour buy_neutral -1.40% | regret=+1.27%
- BUY SNDK | plan_only | edge=+0.82% | conf=0.55 | q=-1.91 | one_hour buy_neutral -1.40% | regret=+1.27%
