...
**Summary / 摘要**: 2026-05-06 共 12 次计划、0 次成交、0 次换汇记录，对账权益 HKD 9,795.93，对账账本周期盈亏 HKD -204.07，对账未实现盈亏 +HKD 173.52。
...
| Benchmarks / 基准快照 | 15 |
| Latest Decision / 最新决策 | [US] 跳过决策 |
| End Equity / 结束权益 | HKD 9,795.93 |
| End Net PnL / 结束累计盈亏 | HKD -204.07 |
| End Unrealized PnL / 结束未实现盈亏 | HKD 173.52 |
| Trade Episodes / 交易片段 | 0 |
