...
**Summary / 摘要**: 2026-05-05 共 41 次计划、0 次成交、0 次换汇记录，对账权益 HKD 9,806.59，对账账本周期盈亏 HKD -193.41，对账未实现盈亏 +HKD 169.32。
...
| Benchmarks / 基准快照 | 6 |
| Latest Decision / 最新决策 | [US] 跳过决策 |
| End Equity / 结束权益 | HKD 9,806.59 |
| End Net PnL / 结束累计盈亏 | HKD -193.41 |
| End Unrealized PnL / 结束未实现盈亏 | HKD 169.32 |
| Trade Episodes / 交易片段 | 0 |
