...
**Summary / 摘要**: 2026-03-27 共 9 次计划、0 次成交、0 次换汇记录，对账权益 HKD 4,533.26，对账累计盈亏 HKD -466.74，对账未实现盈亏 HKD -277.78。
...
| Benchmarks / 基准快照 | 1 |
| Latest Decision / 最新决策 | [HK] 跳过决策 |
| End Equity / 结束权益 | HKD 4,533.26 |
| End Net PnL / 结束累计盈亏 | HKD -466.74 |
| End Unrealized PnL / 结束未实现盈亏 | HKD -277.78 |
| Trade Episodes / 交易片段 | 0 |
