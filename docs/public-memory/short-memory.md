...
**Summary / 摘要**: 2026-03-26 共 7 次计划、0 次成交、0 次换汇记录，对账权益 HKD 4,537.52，对账累计盈亏 HKD -462.48，对账未实现盈亏 HKD -269.66。
...
| Benchmarks / 基准快照 | 27 |
| Latest Decision / 最新决策 | [HK] 跳过决策 |
| End Equity / 结束权益 | HKD 4,537.52 |
| End Net PnL / 结束累计盈亏 | HKD -462.48 |
| End Unrealized PnL / 结束未实现盈亏 | HKD -269.66 |
| Trade Episodes / 交易片段 | 0 |
