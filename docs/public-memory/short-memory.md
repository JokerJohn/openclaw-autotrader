...
**Summary / 摘要**: 2026-03-25 共 5 次计划、0 次成交、0 次换汇记录，对账权益 HKD 4,612.80，对账累计盈亏 HKD -387.20，对账未实现盈亏 HKD -186.26。
...
| Benchmarks / 基准快照 | 14 |
| Latest Decision / 最新决策 | [US] HOLD 无 |
| End Equity / 结束权益 | HKD 4,612.80 |
| End Net PnL / 结束累计盈亏 | HKD -387.20 |
| End Unrealized PnL / 结束未实现盈亏 | HKD -186.26 |
| Trade Episodes / 交易片段 | 0 |
