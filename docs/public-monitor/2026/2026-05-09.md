...
Updated / 更新时间: 2026-05-09 02:16:11 CST
...
- Decision time / 决策时间: 2026-05-09 02:03:35 CST (UTC+08:00)
- Decision / 决策结果: [US] HOLD (no qualified setup) / [US] 观望（无达标机会）
- No-trade rationale / 观望理由: No US candidate cleared the live entry bar. The strongest name, `AAOI`, still showed score -1.11, post-fee EV +0.16%, and win probability 45.5%. / 当前美股活跃池机会评分不足（top_score=-1.11），已跳过本轮决策。
