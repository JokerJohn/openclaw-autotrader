...
| --- | --- | --- | --- | --- |
| `BABA` | 0.938 | HKD 991.23 | HKD -18.91 | Open / 持有中 |

## Latest Decision / 最新决策

- Market state / 市场状态: HK: 非交易时段 | US: 常规交易时段
- Decision time / 决策时间: 2026-03-14 01:50:44 CST (UTC+08:00)
- Decision / 决策结果: [US] HOLD / [US] 观望
- No-trade rationale / 观望理由: No US candidate cleared the live entry bar. The strongest name, `MU`, still showed score -0.71, post-fee EV -0.46%, and win probability 56.9%. / dry-run 本地快评估维持 HOLD。top candidates: MU:-0.71/-0.46% | BABA:-0.97/-1.66% | AVGO:-1.86/-1.26%
