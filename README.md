...
Last synced by decision / 决策触发同步时间: `2026-03-25 02:32:13 CST`
...
| Current equity / 当前权益 | HKD 4,611.79 |
| Net PnL / 累计盈亏 | -HKD 388.21 |
...
- Updated / 更新时间: 2026-03-25 02:31:17 CST (UTC+08:00)
- Current book / 当前组合: `MU`
- Floating PnL / 当前浮动盈亏: -HKD 187.28
...
- Live pools today / 今日实盘池: US: `ASML`, `TSLA`, `AMD`, `QCOM` | HK: none / 暂无. 今日实盘池如上，按市场分别执行。
...
- Latest gate result / 最新门槛结论: No US candidate cleared the live entry bar. The strongest name, `TSLA`, still showed score -2.38, post-fee EV -1.28%, and win probability 60.8%. / compare stage 已确认当前不值得开新风险，直接维持 HOLD。
