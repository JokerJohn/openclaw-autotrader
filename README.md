![Day 89 Poster](./docs/assets/challenge-poster.svg)
...
Last synced by decision / 决策触发同步时间: `2026-06-06 14:45:11 CST`
...
| Metric | Value |
| --- | --- |
| Day / 当前天数 | `89 / 30` (296.7%) |
| Starting capital / 起始资金 | `10000 HKD` |
| Current equity / 当前权益 | HKD 9,799.75 |
| Net PnL / 累计盈亏 | -HKD 200.25 |
...
- Updated / 更新时间: 2026-06-06 14:44:46 CST (UTC+08:00)
...
- Public monitor / 公开监控: [docs/public-monitor/2026/2026-06-06.md](./docs/public-monitor/2026/2026-06-06.md)
- Daily report / 每日报告: [docs/daily-reports/2026/2026-06-06.md](./docs/daily-reports/2026/2026-06-06.md)
...
- Live pools today / 今日实盘池: US: `MU`, `ORCL`, `QCOM`, `AMD` | HK: none / 暂无. 今日实盘池如上，按市场分别执行。
