...
Last synced by decision / 决策触发同步时间: `2026-04-10 00:13:13 CST`
...
| Current equity / 当前权益 | HKD 4,735.41 |
| Net PnL / 累计盈亏 | -HKD 264.59 |
...
- Updated / 更新时间: 2026-04-10 00:06:54 CST (UTC+08:00)
- Current book / 当前组合: `AMZN`
- Floating PnL / 当前浮动盈亏: +HKD 68.46
...
- Live pools today / 今日实盘池: US: `AMZN`, `AMD`, `QCOM`, `TSLA` | HK: none / 暂无. 今日实盘池如上，按市场分别执行。
...
- Latest gate result / 最新门槛结论: 当前仅拿到美股延迟行情，已跳过本轮决策。 / 当前仅拿到美股延迟行情，已跳过本轮决策。
