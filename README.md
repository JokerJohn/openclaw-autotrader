...
Last synced by decision / 决策触发同步时间: `2026-03-17 23:19:03 CST`
...
| Current equity / 当前权益 | HKD 4,961.20 |
| Net PnL / 累计盈亏 | -HKD 38.80 |
...
- Updated / 更新时间: 2026-03-17 23:18:56 CST (UTC+08:00)
- Current book / 当前组合: `BABA`, `MU`
- Floating PnL / 当前浮动盈亏: +HKD 42.34
...
- Live pools today / 今日实盘池: US: `BABA`, `QCOM`, `TSLA`, `RIVN` | HK: none / 暂无. 今日实盘池如上，按市场分别执行。
...
- Latest gate result / 最新门槛结论: No US candidate cleared the live entry bar. The strongest name, `BABA`, still showed score -3.12, post-fee EV -2.03%, and win probability 53.8%. / 无强信号，维持空仓/原仓位。
