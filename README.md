...
Last synced by decision / 决策触发同步时间: `2026-04-01 21:46:47 CST`
...
| Current equity / 当前权益 | HKD 11,169.24 |
| Net PnL / 累计盈亏 | +HKD 6,169.24 |
...
- Updated / 更新时间: 2026-04-01 21:46:47 CST
...
- Latest gate result / 最新门槛结论: No US candidate cleared the live entry bar. The strongest name, `RIVN`, still showed score -1.99, post-fee EV -0.40%, and win probability 61.4%. / 当前美股活跃池机会评分不足（top_score=-1.99），已跳过本轮决策。

## Latest Decision Basis / 最新决策依据

- Result / 结果: [US] HOLD (no qualified setup) / [US] 观望（无达标机会）
- Rationale / 理由: No US candidate cleared the live entry bar. The strongest name, `RIVN`, still showed score -1.99, post-fee EV -0.40%, and win probability 61.4%. / 当前美股活跃池机会评分不足（top_score=-1.99），已跳过本轮决策。
...
- Candidate check / 候选检查: Reviewed 5 active candidate(s). Top checks: `RIVN` (EV) | score -1.99 | post-fee EV -0.40% | win 61.4%; `TSM` (semiconductor) | score -2.07 | post-fee EV -0.35% | win 60.8%; `TSLA` (EV) | score -2.11 | post-fee EV -0.94% | win 60.0%. / 共检查 5 只活跃候选。靠前检查结果：`RIVN`（电动车） | 评分 -1.99 | 扣费后 EV -0.40% | 胜率 61.4%；`TSM`（半导体） | 评分 -2.07 | 扣费后 EV -0.35% | 胜率 60.8%；`TSLA`（电动车） | 评分 -2.11 | 扣费后 EV -0.94% | 胜率 60.0%。
