...
Last synced by decision / 决策触发同步时间: `2026-04-17 22:43:08 CST`
...
| Current equity / 当前权益 | HKD 4,852.63 |
| Net PnL / 累计盈亏 | -HKD 147.37 |
...
- Updated / 更新时间: 2026-04-17 22:43:08 CST
- Current book / 当前组合: No live positions / 暂无公开持仓
- Floating PnL / 当前浮动盈亏: +HKD 114.60
...
- Latest gate result / 最新门槛结论: No US candidate cleared the live entry bar. The strongest name, `XOM`, still showed score -0.93, post-fee EV +0.13%, and win probability 43.8%. / 研究链路未稳定返回，但当前最高候选 XOM 的费后 EV 为 0.13% ，仍低于 live 开仓门槛 0.36% ，按小账户费后纪律继续 HOLD。

## Latest Decision Basis / 最新决策依据

- Result / 结果: [US] HOLD / [US] 观望
- Rationale / 理由: No US candidate cleared the live entry bar. The strongest name, `XOM`, still showed score -0.93, post-fee EV +0.13%, and win probability 43.8%. / 研究链路未稳定返回，但当前最高候选 XOM 的费后 EV 为 0.13% ，仍低于 live 开仓门槛 0.36% ，按小账户费后纪律继续 HOLD。
...
- Candidate check / 候选检查: Reviewed 5 active candidate(s). Top checks: `XOM` (energy) | score -0.93 | post-fee EV +0.13% | win 43.8%; `TSM` (semiconductor) | score -1.52 | post-fee EV -0.33% | win 63.2%; `QCOM` (semiconductor) | score -1.85 | post-fee EV -1.10% | win 57.8%. / 共检查 5 只活跃候选。靠前检查结果：`XOM`（energy） | 评分 -0.93 | 扣费后 EV +0.13% | 胜率 43.8%；`TSM`（半导体） | 评分 -1.52 | 扣费后 EV -0.33% | 胜率 63.2%；`QCOM`（半导体） | 评分 -1.85 | 扣费后 EV -1.10% | 胜率 57.8%。
