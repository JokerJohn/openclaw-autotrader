![Day 86 Poster](./docs/assets/challenge-poster.svg)
...
Last synced by decision / 决策触发同步时间: `2026-06-03 04:01:18 CST`
...
| Metric | Value |
| --- | --- |
| Day / 当前天数 | `86 / 30` (286.7%) |
| Starting capital / 起始资金 | `10000 HKD` |
| Current equity / 当前权益 | HKD 9,800.97 |
| Net PnL / 累计盈亏 | -HKD 199.03 |
...
- Updated / 更新时间: 2026-06-03 03:54:10 CST (UTC+08:00)
...
- Public monitor / 公开监控: [docs/public-monitor/2026/2026-06-03.md](./docs/public-monitor/2026/2026-06-03.md)
- Daily report / 每日报告: [docs/daily-reports/2026/2026-06-03.md](./docs/daily-reports/2026/2026-06-03.md)
...
- Live pools today / 今日实盘池: US: `AAPL`, `RIVN`, `AMD`, `TSLA` | HK: none / 暂无. 今日实盘池如上，按市场分别执行。
