...
Last synced by decision / 决策触发同步时间: `2026-04-21 00:09:42 CST`
...
| Current equity / 当前权益 | HKD 4,812.69 |
| Net PnL / 累计盈亏 | -HKD 187.31 |
...
- Updated / 更新时间: 2026-04-21 00:09:35 CST (UTC+08:00)
- Current book / 当前组合: `AMZN`
- Floating PnL / 当前浮动盈亏: +HKD 85.81
...
- Live pools today / 今日实盘池: US: `MU`, `QCOM`, `AMD`, `TSLA` | HK: none / 暂无. 今日实盘池如上，按市场分别执行。
...
- Latest gate result / 最新门槛结论: No US candidate cleared the live entry bar. The strongest name, `MU`, still showed score -2.05, post-fee EV -1.09%, and win probability 49.1%. / 研究链路未稳定返回，但当前最高候选 MU 的费后 EV 为 -1.09% ，仍低于 live 开仓门槛 0.26% ，按小账户费后纪律继续 HOLD。
