...
Last synced by decision / 决策触发同步时间: `2026-04-22 23:22:37 CST`
...
- Updated / 更新时间: 2026-04-22 23:22:37 CST
...
- Latest gate result / 最新门槛结论: No US candidate cleared the live entry bar. The strongest name, `AVGO`, still showed score -2.04, post-fee EV -0.67%, and win probability 58.7%. / 研究链路未稳定返回，但当前最高候选 AVGO 的费后 EV 为 -0.67% ，仍低于 live 开仓门槛 0.26% ，按小账户费后纪律继续 HOLD。

## Latest Decision Basis / 最新决策依据

- Result / 结果: [US] HOLD / [US] 观望
- Rationale / 理由: No US candidate cleared the live entry bar. The strongest name, `AVGO`, still showed score -2.04, post-fee EV -0.67%, and win probability 58.7%. / 研究链路未稳定返回，但当前最高候选 AVGO 的费后 EV 为 -0.67% ，仍低于 live 开仓门槛 0.26% ，按小账户费后纪律继续 HOLD。
...
- Candidate check / 候选检查: Reviewed 5 active candidate(s). Top checks: `AVGO` (semiconductor) | score -2.04 | post-fee EV -0.67% | win 58.7%; `TSM` (semiconductor) | score -2.76 | post-fee EV -1.40% | win 56.8%; `QCOM` (semiconductor) | score -2.78 | post-fee EV -1.47% | win 53.6%. / 共检查 5 只活跃候选。靠前检查结果：`AVGO`（半导体） | 评分 -2.04 | 扣费后 EV -0.67% | 胜率 58.7%；`TSM`（半导体） | 评分 -2.76 | 扣费后 EV -1.40% | 胜率 56.8%；`QCOM`（半导体） | 评分 -2.78 | 扣费后 EV -1.47% | 胜率 53.6%。
