...
Last synced by decision / 决策触发同步时间: `2026-04-20 23:59:29 CST`
...
| Current equity / 当前权益 | HKD 4,826.04 |
| Net PnL / 累计盈亏 | -HKD 173.96 |
...
- Updated / 更新时间: 2026-04-20 23:59:29 CST
- Current book / 当前组合: No live positions / 暂无公开持仓
- Floating PnL / 当前浮动盈亏: +HKD 85.62
...
- Latest gate result / 最新门槛结论: No US candidate cleared the live entry bar. The strongest name, `MU`, still showed score -2.12, post-fee EV -1.16%, and win probability 49.5%. / 研究链路未稳定返回，但当前最高候选 MU 的费后 EV 为 -1.16% ，仍低于 live 开仓门槛 0.26% ，按小账户费后纪律继续 HOLD。

## Latest Decision Basis / 最新决策依据

- Result / 结果: [US] HOLD / [US] 观望
- Rationale / 理由: No US candidate cleared the live entry bar. The strongest name, `MU`, still showed score -2.12, post-fee EV -1.16%, and win probability 49.5%. / 研究链路未稳定返回，但当前最高候选 MU 的费后 EV 为 -1.16% ，仍低于 live 开仓门槛 0.26% ，按小账户费后纪律继续 HOLD。
...
- Candidate check / 候选检查: Reviewed 5 active candidate(s). Top checks: `MU` (semiconductor) | score -2.12 | post-fee EV -1.16% | win 49.5%; `QCOM` (semiconductor) | score -2.75 | post-fee EV -1.36% | win 53.9%; `AVGO` (semiconductor) | score -3.04 | post-fee EV -1.62% | win 48.8%. / 共检查 5 只活跃候选。靠前检查结果：`MU`（半导体） | 评分 -2.12 | 扣费后 EV -1.16% | 胜率 49.5%；`QCOM`（半导体） | 评分 -2.75 | 扣费后 EV -1.36% | 胜率 53.9%；`AVGO`（半导体） | 评分 -3.04 | 扣费后 EV -1.62% | 胜率 48.8%。
