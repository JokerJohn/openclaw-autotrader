...
Last synced by decision / 决策触发同步时间: `2026-03-18 22:50:11 CST`
...
| Current equity / 当前权益 | HKD 4,977.78 |
| Net PnL / 累计盈亏 | -HKD 22.22 |
...
- Updated / 更新时间: 2026-03-18 22:49:55 CST (UTC+08:00)
- Current book / 当前组合: `BABA`, `MU`
- Floating PnL / 当前浮动盈亏: +HKD 39.57
...
- Live pools today / 今日实盘池: US: `BABA`, `TSLA`, `AMD`, `RIVN` | HK: none / 暂无. 今日实盘池如上，按市场分别执行。
...
- Latest gate result / 最新门槛结论: No US candidate cleared the live entry bar. The strongest name, `BABA`, still showed score -3.09, post-fee EV -1.94%, and win probability 53.8%. / compare stage 已确认当前不值得开新风险，直接维持 HOLD。
