...
Last synced by decision / 决策触发同步时间: `2026-03-25 00:22:40 CST`
...
| Current equity / 当前权益 | HKD 4,615.93 |
| Net PnL / 累计盈亏 | -HKD 384.07 |
...
- Floating PnL / 当前浮动盈亏: -HKD 183.14
...
- Latest gate result / 最新门槛结论: No US candidate cleared the live entry bar. The strongest name, `XOM`, still showed score -1.78, post-fee EV +0.24%, and win probability 63.9%. / 沿用 comparison_stage 的首阶段结论：XOM虽排第一，但费后EV仅0.2366%，低于 fresh live 0.8%门槛；ASML、RIVN费后EV均为负，当前没有一笔新交易能在费用后显著提升 pocket 增长。
