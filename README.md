...
Last synced by decision / 决策触发同步时间: `2026-04-21 22:47:55 CST`
...
| Current equity / 当前权益 | HKD 4,845.80 |
| Net PnL / 累计盈亏 | -HKD 154.20 |
...
- Updated / 更新时间: 2026-04-21 22:47:55 CST
- Current book / 当前组合: No live positions / 暂无公开持仓
- Floating PnL / 当前浮动盈亏: +HKD 105.06
...
- Latest gate result / 最新门槛结论: No US candidate cleared the live entry bar. The strongest name, `MU`, still showed score -2.48, post-fee EV -1.74%, and win probability 55.7%. / 研究链路未稳定返回，但当前最高候选 MU 的费后 EV 为 -1.74% ，仍低于 live 开仓门槛 0.26% ，按小账户费后纪律继续 HOLD。

## Latest Decision Basis / 最新决策依据

- Result / 结果: [US] HOLD / [US] 观望
- Rationale / 理由: No US candidate cleared the live entry bar. The strongest name, `MU`, still showed score -2.48, post-fee EV -1.74%, and win probability 55.7%. / 研究链路未稳定返回，但当前最高候选 MU 的费后 EV 为 -1.74% ，仍低于 live 开仓门槛 0.26% ，按小账户费后纪律继续 HOLD。
...
- Candidate check / 候选检查: Reviewed 5 active candidate(s). Top checks: `MU` (semiconductor) | score -2.48 | post-fee EV -1.74% | win 55.7%; `AMD` (semiconductor) | score -2.50 | post-fee EV -1.12% | win 55.3%; `ORCL` (cloud software) | score -2.86 | post-fee EV -0.65% | win 53.2%. / 共检查 5 只活跃候选。靠前检查结果：`MU`（半导体） | 评分 -2.48 | 扣费后 EV -1.74% | 胜率 55.7%；`AMD`（半导体） | 评分 -2.50 | 扣费后 EV -1.12% | 胜率 55.3%；`ORCL`（云软件） | 评分 -2.86 | 扣费后 EV -0.65% | 胜率 53.2%。
