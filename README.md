...
Last synced by decision / 决策触发同步时间: `2026-05-06 22:29:32 CST`
...
| Current equity / 当前权益 | HKD 9,813.98 |
| Net PnL / 累计盈亏 | -HKD 186.02 |
...
- Updated / 更新时间: 2026-05-06 22:29:32 CST
- Current book / 当前组合: No live positions / 暂无公开持仓
- Floating PnL / 当前浮动盈亏: +HKD 175.48
...
- Latest gate result / 最新门槛结论: No US candidate cleared the live entry bar. The strongest name, `QCOM`, still showed score +0.43, post-fee EV +0.47%, and win probability 64.0%. / 无强信号，维持空仓/原仓位。

## Latest Decision Basis / 最新决策依据

- Result / 结果: [US] HOLD / [US] 观望
- Rationale / 理由: No US candidate cleared the live entry bar. The strongest name, `QCOM`, still showed score +0.43, post-fee EV +0.47%, and win probability 64.0%. / 无强信号，维持空仓/原仓位。
...
- Candidate check / 候选检查: Reviewed 5 active candidate(s). Top checks: `QCOM` (semiconductor) | score +0.43 | post-fee EV +0.47% | win 64.0%; `XOM` (energy) | score -3.09 | post-fee EV -0.66% | win 41.8%; `MU` (semiconductor) | score -3.29 | post-fee EV -1.30% | win 59.4%. / 共检查 5 只活跃候选。靠前检查结果：`QCOM`（半导体） | 评分 +0.43 | 扣费后 EV +0.47% | 胜率 64.0%；`XOM`（energy） | 评分 -3.09 | 扣费后 EV -0.66% | 胜率 41.8%；`MU`（半导体） | 评分 -3.29 | 扣费后 EV -1.30% | 胜率 59.4%。
