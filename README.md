![Day 18 Poster](./docs/assets/challenge-poster.svg)
...
Last synced by decision / 决策触发同步时间: `2026-03-27 00:04:18 CST`
...
| Current equity / 当前权益 | HKD 4,528.12 |
| Net PnL / 累计盈亏 | -HKD 471.88 |
...
- Updated / 更新时间: 2026-03-27 00:02:50 CST (UTC+08:00)
- Current book / 当前组合: No live positions / 暂无公开持仓
- Floating PnL / 当前浮动盈亏: -HKD 270.94
- Latest decision / 最新决策: 
- Next milestone / 下一阶段: Day `19` of `30`
- Public monitor / 公开监控: [docs/public-monitor/2026/2026-03-27.md](./docs/public-monitor/2026/2026-03-27.md)
- Daily report / 每日报告: [docs/daily-reports/2026/2026-03-27.md](./docs/daily-reports/2026/2026-03-27.md)
...
- Live pools today / 今日实盘池: US: `AAOI`, `SNDK`, `META`, `XOM` | HK: none / 暂无. 今日实盘池如上，按市场分别执行。
