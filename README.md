...
Last synced by decision / 决策触发同步时间: `2026-04-02 00:19:28 CST`
...
- Live pools today / 今日实盘池: US: `XOM`, `AMZN`, `RIVN`, `QCOM` | HK: none / 暂无. 今日实盘池如上，按市场分别执行。
...
- Latest gate result / 最新门槛结论: No US candidate cleared the live entry bar. The strongest name, `GOOGL`, still showed score -1.92, post-fee EV -0.26%, and win probability 63.8%. / 当前美股活跃池机会评分不足（top_score=-1.92），已跳过本轮决策。
