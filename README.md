...
Last synced by decision / 决策触发同步时间: `2026-04-21 22:09:06 CST`
...
| Current equity / 当前权益 | HKD 4,848.15 |
| Net PnL / 累计盈亏 | -HKD 151.85 |
...
- Updated / 更新时间: 2026-04-21 22:09:06 CST
- Current book / 当前组合: No live positions / 暂无公开持仓
- Floating PnL / 当前浮动盈亏: +HKD 107.40
...
- Latest gate result / 最新门槛结论: No US candidate cleared the live entry bar. The strongest name, `MU`, still showed score -1.35, post-fee EV -1.47%, and win probability 58.7%. / 研究链路未稳定返回，但当前最高候选 MU 的费后 EV 为 -1.47% ，仍低于 live 开仓门槛 0.30% ，按小账户费后纪律继续 HOLD。

## Latest Decision Basis / 最新决策依据

- Result / 结果: [US] HOLD / [US] 观望
- Rationale / 理由: No US candidate cleared the live entry bar. The strongest name, `MU`, still showed score -1.35, post-fee EV -1.47%, and win probability 58.7%. / 研究链路未稳定返回，但当前最高候选 MU 的费后 EV 为 -1.47% ，仍低于 live 开仓门槛 0.30% ，按小账户费后纪律继续 HOLD。
...
- Candidate check / 候选检查: Reviewed 5 active candidate(s). Top checks: `MU` (semiconductor) | score -1.35 | post-fee EV -1.47% | win 58.7%; `TSM` (semiconductor) | score -2.47 | post-fee EV -1.87% | win 54.0%; `AMD` (semiconductor) | score -2.54 | post-fee EV -1.17% | win 54.2%. / 共检查 5 只活跃候选。靠前检查结果：`MU`（半导体） | 评分 -1.35 | 扣费后 EV -1.47% | 胜率 58.7%；`TSM`（半导体） | 评分 -2.47 | 扣费后 EV -1.87% | 胜率 54.0%；`AMD`（半导体） | 评分 -2.54 | 扣费后 EV -1.17% | 胜率 54.2%。
