...
Last synced by decision / 决策触发同步时间: `2026-04-01 22:21:30 CST`
...
- Updated / 更新时间: 2026-04-01 22:21:30 CST
...
- Latest gate result / 最新门槛结论: No US candidate cleared the live entry bar. The strongest name, `TSLA`, still showed score -1.79, post-fee EV -1.35%, and win probability 64.4%. / 当前美股活跃池机会评分不足（top_score=-1.79），已跳过本轮决策。

## Latest Decision Basis / 最新决策依据

- Result / 结果: [US] HOLD (no qualified setup) / [US] 观望（无达标机会）
- Rationale / 理由: No US candidate cleared the live entry bar. The strongest name, `TSLA`, still showed score -1.79, post-fee EV -1.35%, and win probability 64.4%. / 当前美股活跃池机会评分不足（top_score=-1.79），已跳过本轮决策。
...
- Candidate check / 候选检查: Reviewed 5 active candidate(s). Top checks: `TSLA` (EV) | score -1.79 | post-fee EV -1.35% | win 64.4%; `TSM` (semiconductor) | score -2.08 | post-fee EV -0.60% | win 64.5%; `QCOM` (semiconductor) | score -2.48 | post-fee EV -1.47% | win 61.1%. / 共检查 5 只活跃候选。靠前检查结果：`TSLA`（电动车） | 评分 -1.79 | 扣费后 EV -1.35% | 胜率 64.4%；`TSM`（半导体） | 评分 -2.08 | 扣费后 EV -0.60% | 胜率 64.5%；`QCOM`（半导体） | 评分 -2.48 | 扣费后 EV -1.47% | 胜率 61.1%。
