...
Last synced by decision / 决策触发同步时间: `2026-04-14 23:22:10 CST`
...
| Current equity / 当前权益 | HKD 4,830.29 |
| Net PnL / 累计盈亏 | -HKD 169.71 |
...
- Updated / 更新时间: 2026-04-14 23:22:10 CST
- Current book / 当前组合: No live positions / 暂无公开持仓
- Floating PnL / 当前浮动盈亏: +HKD 88.57
...
- Latest gate result / 最新门槛结论: No US candidate cleared the live entry bar. The strongest name, `META`, still showed score -2.11, post-fee EV -0.22%, and win probability 57.5%. / 研究链路未稳定返回，但当前最高候选 META 的费后 EV 为 -0.22% ，仍低于 live 开仓门槛 0.42% ，按小账户费后纪律继续 HOLD。

## Latest Decision Basis / 最新决策依据

- Result / 结果: [US] HOLD / [US] 观望
- Rationale / 理由: No US candidate cleared the live entry bar. The strongest name, `META`, still showed score -2.11, post-fee EV -0.22%, and win probability 57.5%. / 研究链路未稳定返回，但当前最高候选 META 的费后 EV 为 -0.22% ，仍低于 live 开仓门槛 0.42% ，按小账户费后纪律继续 HOLD。
...
- Candidate check / 候选检查: Reviewed 5 active candidate(s). Top checks: `META` (internet platform) | score -2.11 | post-fee EV -0.22% | win 57.5%; `MU` (semiconductor) | score -2.26 | post-fee EV -0.97% | win 59.5%; `AMZN` (cloud software) | score -2.42 | post-fee EV -0.82% | win 52.4%. / 共检查 5 只活跃候选。靠前检查结果：`META`（互联网平台） | 评分 -2.11 | 扣费后 EV -0.22% | 胜率 57.5%；`MU`（半导体） | 评分 -2.26 | 扣费后 EV -0.97% | 胜率 59.5%；`AMZN`（云软件） | 评分 -2.42 | 扣费后 EV -0.82% | 胜率 52.4%。
