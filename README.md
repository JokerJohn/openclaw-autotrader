![Day 96 Poster](./docs/assets/challenge-poster.svg)
...
Last synced by decision / 决策触发同步时间: `2026-06-13 22:08:28 CST`
...
| Metric | Value |
| --- | --- |
| Day / 当前天数 | `96 / 30` (320.0%) |
| Starting capital / 起始资金 | `10000 HKD` |
| Current equity / 当前权益 | HKD 9,800.51 |
| Net PnL / 累计盈亏 | -HKD 199.49 |
...
- Updated / 更新时间: 2026-06-13 22:08:28 CST
...
- Public monitor / 公开监控: [docs/public-monitor/2026/2026-06-13.md](./docs/public-monitor/2026/2026-06-13.md)
- Daily report / 每日报告: [docs/daily-reports/2026/2026-06-13.md](./docs/daily-reports/2026/2026-06-13.md)
...
- Session discipline / 时段纪律: live decisions stay inside regular sessions, capped at 0 trade(s) per hour, with a 5% cash reserve and HKD 5000 daily loss stop. 实盘决策仅在常规交易时段内执行，每小时最多 0 笔，并保留 5% 现金缓冲，单日亏损达到 HKD 5000 即停止扩张。
...
- Latest gate result / 最新门槛结论: 当前 Tiger API 没有美股实时行情权限，已跳过本轮决策。 / 当前 Tiger API 没有美股实时行情权限，已跳过本轮决策。
