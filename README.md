...
Last synced by decision / 决策触发同步时间: `2026-04-22 22:52:24 CST`
...
| Current equity / 当前权益 | HKD 4,846.37 |
| Net PnL / 累计盈亏 | -HKD 153.63 |
...
- Updated / 更新时间: 2026-04-22 22:52:24 CST
- Current book / 当前组合: No live positions / 暂无公开持仓
- Floating PnL / 当前浮动盈亏: +HKD 105.69
...
- Latest gate result / 最新门槛结论: No US candidate cleared the live entry bar. The strongest name, `AVGO`, still showed score -2.29, post-fee EV -0.92%, and win probability 58.0%. / 研究链路未稳定返回，但当前最高候选 AVGO 的费后 EV 为 -0.92% ，仍低于 live 开仓门槛 0.26% ，按小账户费后纪律继续 HOLD。

## Latest Decision Basis / 最新决策依据

- Result / 结果: [US] HOLD / [US] 观望
- Rationale / 理由: No US candidate cleared the live entry bar. The strongest name, `AVGO`, still showed score -2.29, post-fee EV -0.92%, and win probability 58.0%. / 研究链路未稳定返回，但当前最高候选 AVGO 的费后 EV 为 -0.92% ，仍低于 live 开仓门槛 0.26% ，按小账户费后纪律继续 HOLD。
...
- Candidate check / 候选检查: Reviewed 5 active candidate(s). Top checks: `AVGO` (semiconductor) | score -2.29 | post-fee EV -0.92% | win 58.0%; `TSM` (semiconductor) | score -2.57 | post-fee EV -1.21% | win 57.4%; `QCOM` (semiconductor) | score -3.03 | post-fee EV -1.72% | win 52.8%. / 共检查 5 只活跃候选。靠前检查结果：`AVGO`（半导体） | 评分 -2.29 | 扣费后 EV -0.92% | 胜率 58.0%；`TSM`（半导体） | 评分 -2.57 | 扣费后 EV -1.21% | 胜率 57.4%；`QCOM`（半导体） | 评分 -3.03 | 扣费后 EV -1.72% | 胜率 52.8%。
