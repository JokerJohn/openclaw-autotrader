...
Last synced by decision / 决策触发同步时间: `2026-04-22 23:52:50 CST`
...
| Current equity / 当前权益 | HKD 4,845.34 |
| Net PnL / 累计盈亏 | -HKD 154.66 |
...
- Updated / 更新时间: 2026-04-22 23:52:50 CST
- Current book / 当前组合: No live positions / 暂无公开持仓
- Floating PnL / 当前浮动盈亏: +HKD 104.67
...
- Latest gate result / 最新门槛结论: No US candidate cleared the live entry bar. The strongest name, `TSM`, still showed score -2.35, post-fee EV -0.99%, and win probability 58.1%. / 研究链路未稳定返回，但当前最高候选 TSM 的费后 EV 为 -0.99% ，仍低于 live 开仓门槛 0.26% ，按小账户费后纪律继续 HOLD。

## Latest Decision Basis / 最新决策依据

- Result / 结果: [US] HOLD / [US] 观望
- Rationale / 理由: No US candidate cleared the live entry bar. The strongest name, `TSM`, still showed score -2.35, post-fee EV -0.99%, and win probability 58.1%. / 研究链路未稳定返回，但当前最高候选 TSM 的费后 EV 为 -0.99% ，仍低于 live 开仓门槛 0.26% ，按小账户费后纪律继续 HOLD。
...
- Candidate check / 候选检查: Reviewed 5 active candidate(s). Top checks: `TSM` (semiconductor) | score -2.35 | post-fee EV -0.99% | win 58.1%; `AAPL` (consumer hardware) | score -2.98 | post-fee EV -1.12% | win 54.4%; `QCOM` (semiconductor) | score -3.13 | post-fee EV -1.82% | win 51.8%. / 共检查 5 只活跃候选。靠前检查结果：`TSM`（半导体） | 评分 -2.35 | 扣费后 EV -0.99% | 胜率 58.1%；`AAPL`（消费硬件） | 评分 -2.98 | 扣费后 EV -1.12% | 胜率 54.4%；`QCOM`（半导体） | 评分 -3.13 | 扣费后 EV -1.82% | 胜率 51.8%。
