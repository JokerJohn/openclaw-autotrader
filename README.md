...
Last synced by decision / 决策触发同步时间: `2026-04-01 23:55:22 CST`
...
- Updated / 更新时间: 2026-04-01 23:55:22 CST
...
- Latest gate result / 最新门槛结论: No US candidate cleared the live entry bar. The strongest name, `LLY`, still showed score -2.09, post-fee EV -0.38%, and win probability 64.1%. / 当前美股活跃池机会评分不足（top_score=-2.09），已跳过本轮决策。

## Latest Decision Basis / 最新决策依据

- Result / 结果: [US] HOLD (no qualified setup) / [US] 观望（无达标机会）
- Rationale / 理由: No US candidate cleared the live entry bar. The strongest name, `LLY`, still showed score -2.09, post-fee EV -0.38%, and win probability 64.1%. / 当前美股活跃池机会评分不足（top_score=-2.09），已跳过本轮决策。
...
- Candidate check / 候选检查: Reviewed 5 active candidate(s). Top checks: `LLY` (pharma) | score -2.09 | post-fee EV -0.38% | win 64.1%; `GOOGL` (internet platform) | score -2.21 | post-fee EV -0.48% | win 63.8%; `RIVN` (EV) | score -2.39 | post-fee EV -1.47% | win 63.9%. / 共检查 5 只活跃候选。靠前检查结果：`LLY`（pharma） | 评分 -2.09 | 扣费后 EV -0.38% | 胜率 64.1%；`GOOGL`（互联网平台） | 评分 -2.21 | 扣费后 EV -0.48% | 胜率 63.8%；`RIVN`（电动车） | 评分 -2.39 | 扣费后 EV -1.47% | 胜率 63.9%。
