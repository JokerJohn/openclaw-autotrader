...
Last synced by decision / 决策触发同步时间: `2026-04-02 22:11:47 CST`
...
- Updated / 更新时间: 2026-04-02 22:11:47 CST
...
- Latest gate result / 最新门槛结论: No US candidate cleared the live entry bar. The strongest name, `TSLA`, still showed score -1.73, post-fee EV -1.22%, and win probability 51.8%. / 当前美股活跃池机会评分不足（top_score=-1.73），已跳过本轮决策。

## Latest Decision Basis / 最新决策依据

- Result / 结果: [US] HOLD (no qualified setup) / [US] 观望（无达标机会）
- Rationale / 理由: No US candidate cleared the live entry bar. The strongest name, `TSLA`, still showed score -1.73, post-fee EV -1.22%, and win probability 51.8%. / 当前美股活跃池机会评分不足（top_score=-1.73），已跳过本轮决策。
...
- Candidate check / 候选检查: Reviewed 5 active candidate(s). Top checks: `TSLA` (EV) | score -1.73 | post-fee EV -1.22% | win 51.8%; `AMD` (semiconductor) | score -2.09 | post-fee EV -1.35% | win 49.8%; `XOM` (energy) | score -2.85 | post-fee EV -0.99% | win 62.8%. / 共检查 5 只活跃候选。靠前检查结果：`TSLA`（电动车） | 评分 -1.73 | 扣费后 EV -1.22% | 胜率 51.8%；`AMD`（半导体） | 评分 -2.09 | 扣费后 EV -1.35% | 胜率 49.8%；`XOM`（energy） | 评分 -2.85 | 扣费后 EV -0.99% | 胜率 62.8%。
