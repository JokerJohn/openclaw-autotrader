...
Last synced by decision / 决策触发同步时间: `2026-03-25 04:00:49 CST`
...
| Current equity / 当前权益 | HKD 4,621.51 |
| Net PnL / 累计盈亏 | -HKD 378.49 |
...
- Updated / 更新时间: 2026-03-25 03:59:57 CST (UTC+08:00)
- Current book / 当前组合: `MU`
- Floating PnL / 当前浮动盈亏: -HKD 177.55
...
- Live pools today / 今日实盘池: US: `ASML`, `RIVN`, `TSLA`, `AMD` | HK: none / 暂无. 今日实盘池如上，按市场分别执行。
...
- Latest gate result / 最新门槛结论: No US candidate cleared the live entry bar. The strongest name, `TSLA`, still showed score -2.29, post-fee EV -1.22%, and win probability 62.0%. / compare stage 已确认当前不值得开新风险，直接维持 HOLD。
