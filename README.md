...
Last synced by decision / 决策触发同步时间: `2026-03-24 21:54:20 CST`
...
| Current equity / 当前权益 | HKD 4,643.65 |
| Net PnL / 累计盈亏 | -HKD 356.35 |
...
- Updated / 更新时间: 2026-03-24 21:53:18 CST (UTC+08:00)
- Current book / 当前组合: `MU`
- Floating PnL / 当前浮动盈亏: -HKD 171.07
...
- Live pools today / 今日实盘池: US: `TSM`, `TSLA`, `RIVN`, `QCOM` | HK: none / 暂无. 今日实盘池如上，按市场分别执行。
...
- Latest gate result / 最新门槛结论: No US candidate cleared the live entry bar. The strongest name, `TSM`, still showed score -1.80, post-fee EV -0.89%, and win probability 55.5%. / compare stage 已确认当前不值得开新风险，直接维持 HOLD。
